                ...
                <div class="date-input-wrapper">
                    ...
                    >
                        <div class="date-calendar-header">
                            ...
                            <strong id="fineCalendarLabel"></strong>
                        ...
                        <div
                            id="fineDateCalendarDays"
                            class="date-calendar-days"
                        ></div>
                    </div>
...
if (
    ...
    function updateRules() {
        ...
        const        const fineDateInput =
            document.getElementById(
                "fineDate"
            );

        const fineDateCalendar =
            document.getElementById(
                "fineDateCalendar"
            );

        const fineCalendarLabel =
            document.getElementById(
                "fineCalendarLabel"
            );

        const fineCalendarDays =
            document.getElementById(
                "fineDateCalendarDays"
            );

        const selectedFineDate =
            parseFineDate(
                fineDateInput.value
            ) ||
            new Date()
        ...
        let fineCalendarMonth =
            new Date(
                selectedFineDate +
                "T12:00:00"
            );

        fineCalendarMonth.setDate(1);

        function renderFineDateCalendar() {

            const year =
                fineCalendarMonth.getFullYear();

            const month =
                fineCalendarMonth.getMonth();

            fineCalendarLabel.textContent =
                new Date(
                    year,
                    month,
                    1
        ...
        document
            .getElementById(
                "fineCalendarPrevious"
            )
            .addEventListener(
                "click",
                () => {
                    fineCalendarMonth.setMonth(
                        fineCalendarMonth.getMonth() -
                        1
                    );
